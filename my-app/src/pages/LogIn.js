...
const LogIn = () => {
  ...
  <div class="p-4 justify-center items-center">
    ...
    <a href="#" class="font-bold text-white hover:text-blue-600 pl-2">Sign up</a> </p>
    <div className="mb-6 pt-8">
          ...
          <div className='  pl-2'>
    <button class="mt-4  bg-blue-500 hover:bg-blue-500 text-white font-bold py-2 px-40  rounded-xl justify-center items-center ">LogIn</button></div>
  </div>
